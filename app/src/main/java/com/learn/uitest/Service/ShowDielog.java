...
public class ShowDielog {
    ...
    public static void showTitleChooseButtomDig(Context mContext,String title,String[] input,View view,final DialogDoing event){
        final ActionSheetDialog dialog = new ActionSheetDialog(mContext,input,view);
        dialog.title(title).titleTextSize_SP(14.5f).show();
